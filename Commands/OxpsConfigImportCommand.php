...
/**
 * Class OxpsConfigImportCommand
 */
class OxpsConfigImportCommand extends Command
{
    ...
    {
        /*
           I think we don't need this any more because the class will be found
           thanks to composer autoloader and classe name.
        */
